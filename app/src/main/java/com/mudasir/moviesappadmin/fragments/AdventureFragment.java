...
public class AdventureFragment extends Fragment {
    ...
    private void init(View view) {
        ...
        mRecyclerView=view.findViewById(R.id.rvAdventure_movies);
        mlayoutManager=new LinearLayoutManager(getContext());
        mRecyclerView.setLayoutManager(mlayoutManager);
        mRecyclerView.setHasFixedSize(true);

        mDataBaseRef= FirebaseDatabase.getInstance().getReference("Movies").child("Adventure");
        mStorageRef= FirebaseStorage.getInstance().getReference("MoviesThumbnail").child("Adventure");
